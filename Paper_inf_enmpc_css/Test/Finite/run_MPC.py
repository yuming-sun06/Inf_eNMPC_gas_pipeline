...
from terminal import update_controller_obj
from utils import (
    Tee,
...
def run_nmpc(
    ...
    for iteration in range(simulation_steps):
        ...
        lyapunov_values[iteration] = pyo.value(
            m_controller.lyapunov_function_current
        )
...
def write_results(
    ...
    write_data_to_excel(
        ...
        sheets_keys_dict,
        output_path,
        controller_1_lyapunov=lyapunov_values,
...
def main(soft=False, unfix_P_at_t0=False):
...
if __name__ == "__main__":
    soft = False # 1 cycle = T, 10 cycle = F
    unfix_P_at_t0 = False
    ...
    try:
        ...
        main(soft=soft, unfix_P_at_t0=unfix_P_at_t0)
