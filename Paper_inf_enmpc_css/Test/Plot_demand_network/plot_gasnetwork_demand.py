...
from utils import import_data_from_excel, dynamic_demand_profile

# Use Matplotlib mathtext without requiring an external LaTeX installation.
plt.rcParams["text.usetex"] = False

BASE_DIR     = os.path.dirname(os.path.abspath(__file__))
NETWORK_FILE = os.path.join(BASE_DIR, "test_kai", "networkData.xlsx")
INPUT_FILE   = os.path.join(BASE_DIR, "test_kai", "inputData.xlsx")
...
def main():
    ...
    # Save the network schematic before renaming it for this test case.
