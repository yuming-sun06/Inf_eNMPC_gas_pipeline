...
def load_css(m, ocss_file_path):
    # Tracking warm-up may load the reference before terminal constraints are
    # added.  Reusing the existing fixed reference avoids duplicate Pyomo
    # components when the terminal setup calls this function again.
